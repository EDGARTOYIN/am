...
//Obteniendo el total de productos y el precio total
...
//Obteniendo la cantidad de cada producto
...
$empy_cart="Delete from `cart_details` where ip_address='$get_ip_address'";
$result_delete=mysqli_query($conn,$empy_cart);
